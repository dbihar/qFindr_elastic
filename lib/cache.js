                ...
                for(var i = 0; i < len; i++)
                {
                  ...
                  if (typeof jsonArray[i]["_source"].path === 'undefined') {
                    if (typeof jsonArray[i]["_source"].filename === 'undefined'){
                      ...
                      jsonArray[i]["_source"].filename = "Outlook MSG | Subject: " + jsonArray[i]["_source"].subject + " | Sender: " + jsonArray[i]["_source"].sender_name
                      jsonArray[i]["_source"].path = "Recipients: " + jsonArray[i]["_source"].recipients_names.join(', ')
                    }
                    else{
                      //console.info("This is atach result")
                      jsonArray[i]["_source"].path = "Outlook ATCH | Subject: " + jsonArray[i]["_source"].subject + " | Sender: " + jsonArray[i]["_source"].sender_name
                    }
                    // color is undefined
                    is_msg = true
                  }
                  ...
                  // Shortening filename
                  if(jsonArray[i]["_source"].filename.length > 100){
                    jsonArray[i]["_source"].filename = jsonArray[i]["_source"].filename.substring(0,45).concat("...").concat(path_short.substring(jsonArray[i]["_source"].filename.length-52, jsonArray[i]["_source"].filename.length))
                  }

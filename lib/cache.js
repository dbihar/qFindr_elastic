        ...
        */
        ...
        for (var item in list_q) {
          if(count_quote % 2 == 1){
            ...
            query_new = query_new.concat(list_q[count_quote])
          }
          count_quote ++;
        }
        console.info(query_new)
        query = query_new
        //query = "*".concat(query).replace(/ /g, "* AND *").concat("*")
        var qryObj = {
          "query" : {
          ...
          this.elasticSearchClient.search('*', '_doc', qryObj)
            .on('data', function(data) {
                ...
                for(var i = 0; i < len; i++)
                {
                  ...
                  var tmp = null
                  // Shortening path:
                  if(path_short.length > 90){
                    path_short = path_short.substring(0,30).concat("...").concat(path_short.substring(path_short.length-57, path_short.length))
                  }
                  ...
                  if(extension =='doc' || extension == 'docx' ||
                    extension =='dot' || extension =='odt'){ic='fa-solid fa-file-word fa-2x'}
                  else if(extension =='ppt' || extension == 'pptx' ||
                          extension =='pps' || extension =='odp'){ic='fa-solid fa-file-powerpoint fa-2x'}
                  else if(extension =='xls' || extension == 'xlsx' ||
                          extension =='ods'){ic='fa-regular fa-file-excel fa-2x'}
                  else if(extension =='html' || extension == 'mht' ||
                          extension =='xml' || extension == 'htm'){ic='fa-solid fa-file-code fa-2x'}
                  else if(extension =='csv'){ic='fa-regular fa-file-csv fa-2x'}
                  else if(extension =='txt' || extension == 'rtf'){ic='fa-regular fa-file fa-2x'}
                  else if(extension =='pdf'){ic='fa-regular fa-file-pdf fa-2x'}
                  else if(extension =='exe' || extension =='bin' || extension =='msi'){ic='fa-regular fa-rocket fa-2x'}
                  else if(extension =='zip' || extension =='rar' || 
                          extension =='cab' || extension =='bz' || extension =='gz' ||
                          extension =='xz'){ic='fa-regular fa-file-zipper fa-2x'}
                  else if(extension =='jpg' || extension =='jpeg' || 
                          extension =='bmp' || extension =='ico' || extension =='png' ||
                          extension =='ps'){ic='fa-regular fa-file-image fa-2x'}
                  else{ic='fa-regular fa-file fa-2x'}
                  
                  // Handle if it's outlook mail
                  if(is_msg){
                    ic = 'fa-solid fa-envelope fa-2x'
